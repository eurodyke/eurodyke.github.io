...
const init_phones = ["HTH67"],                      // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      DIR = "HP-s/",                                // Directory where graph files are stored
      data_format = "AudioTools",                   // Accepts "AudioTools," "REW," or "other"
      default_channels = ["L","R"],                 // Which channels to display. Avoid javascript errors if loading just one channel per phone
      default_normalization = "dB",                 // Sets default graph normalization mode. Accepts "dB" or "Hz"
      default_norm_db = 0,                         // Sets default dB normalization point
      ...
      site_url = 'iframe.html',                      // URL of your graph "homepage"
      share_url = true,                             // If true, enables shareable URLs
      watermark_text = "euroGraph",                 // Optional. Watermark appears behind graphs
      watermark_image_url = "eurodyke-watermark.png",   // Optional. If image file is in same directory as config, can be just the filename
      page_title = "euroGraph",                     // Optional. Appended to the page title if share URLs are enabled
      ...
      headerHeight = '20px',                         // Optional. If expandable=true, determines how much space to leave for the parent page header
